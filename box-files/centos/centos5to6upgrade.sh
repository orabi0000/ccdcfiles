...
wget --no-check-certificate -c http://vault.centos.org/6.5/os/Source/SPackages/centos-release-6-5.el6.centos.11.1.src.rpm
...
wget -c --no-check-certificate http://mirror.centos.org/centos/6/os/x86_64/Packages/xz-4.999.9-0.3.beta.20091007git.el6.x86_64.rpm \
         http://mirror.centos.org/centos/6/os/x86_64/Packages/xz-libs-4.999.9-0.3.beta.20091007git.el6.x86_64.rpm
rpm -Uvh xz-*

# Fix cpio
wget -c --no-check-certificate http://vault.centos.org/6.5/os/Source/SPackages/cpio-2.10-11.el6_3.src.rpm
...
wget -c --no-check-certificate http://mirror.centos.org/centos/6/os/x86_64/Packages/glibc-2.12-1.132.el6.x86_64.rpm \
